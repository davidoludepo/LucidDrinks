...
public class VendorActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    Button PassDataAlso;
    final String[] drinksnames = new String[]{"Can Mirinda", "Glass Mirinda", "Pet Mirinda", "Can Pepsi", "Glass Pepsi", "Pet Pepsi", "Can Savanna", "Pet Savanna", "Can SevenUp", "Glass SevenUp", "Pet SevenUp", "Small Glass Sprite", "Big Glass Sprite", "Pet Sprite", "Pet Teem", "Pet Lacasera", "Pet Smoov", "Small Glass Coke", "Big Glass Coke","Small Pet Coke", "Big Pet Coke", "Small Glass Fanta", "Big Glass Fanta", "Small Pet Fanta", "Big Pet Fanta", "Sachet Water", "Pet Water", "Can MaltaGold", "Can Maltina", "Can Himalt", "Can MaltaGuinness", "5Alive Juice", "Small Hollandia Juice", "Big Hollandia Juice", "Small ChiExotic Juice", "Big ChiExotic Juice", "Small Chivita Juice", "Big Chivita Juice", "Small HappyHour Juice", "Big HappyHour Juice", "Small Glass Schweppes", "Big Glass Schweppes", "Pet Schweppes"};
    int[] drinksimages = {R.drawable.c_mirinda_can, R.drawable.c_mirinda_glass, R.drawable.c_mirinda_pet, R.drawable.c_pepsi_can, R.drawable.c_pepsi_glass, R.drawable.c_pepsi_pet, R.drawable.c_savanna_can, R.drawable.c_savanna_pet, R.drawable.c_sevenup_can, R.drawable.c_sevenup_glass, R.drawable.c_sevenup_pet, R.drawable.c_sprite_small_glass, R.drawable.c_sprite_big_glass, R.drawable.c_sprite_pet, R.drawable.c_teem_pet, R.drawable.c_lacasera_pet, R.drawable.c_smoov_pet, R.drawable.c_cocacola_small_glass, R.drawable.c_cocacola_big_glass, R.drawable.c_cocacola_small_pet, R.drawable.c_cocacola_big_pet, R.drawable.c_fanta_small_glass, R.drawable.c_fanta_big_glass, R.drawable.c_fanta_small_pet, R.drawable.c_fanta_big_pet, R.drawable.c_water_sachet, R.drawable.c_water_pet, R.drawable.c_maltagold_can, R.drawable.c_maltina_can, R.drawable.c_himalt_can, R.drawable.c_maltaguiness_can, R.drawable.c_fivealive_juice, R.drawable.c_hollandia_small_juice, R.drawable.c_hollandia_big_juice, R.drawable.c_chiexotic_small_juice, R.drawable.c_chiexotic_big_juice, R.drawable.c_chivita_small_juice, R.drawable.c_chivita_big_juice, R.drawable.c_happyhour_small_juice, R.drawable.c_happyhour_big_juice, R.drawable.c_schweppes_small_glass, R.drawable.c_schweppes_big_glass, R.drawable.c_schweppes_pet};
    TextView sellerId;
...
//        All.setVisibility(View.GONE);
    ...
    private ArrayList<Icdat> getIcdats() {
        ...
        icdats.add(new Icdat(drinksnames[0], drinksimages[0], smoothy));
        icdats.add(new Icdat(drinksnames[1], drinksimages[1], smoothy));
        icdats.add(new Icdat(drinksnames[2], drinksimages[2], smoothy));
        icdats.add(new Icdat(drinksnames[3], drinksimages[3], smoothy));
        icdats.add(new Icdat(drinksnames[4], drinksimages[4], smoothy));
        icdats.add(new Icdat(drinksnames[5], drinksimages[5], smoothy));
        icdats.add(new Icdat(drinksnames[6], drinksimages[6], smoothy));
        icdats.add(new Icdat(drinksnames[7], drinksimages[7], smoothy));
        icdats.add(new Icdat(drinksnames[8], drinksimages[8], smoothy));
        icdats.add(new Icdat(drinksnames[9], drinksimages[9], smoothy));
        icdats.add(new Icdat(drinksnames[10], drinksimages[10], smoothy));
        icdats.add(new Icdat(drinksnames[11], drinksimages[11], smoothy));
        icdats.add(new Icdat(drinksnames[12], drinksimages[12], smoothy));
        icdats.add(new Icdat(drinksnames[13], drinksimages[13], smoothy));
        icdats.add(new Icdat(drinksnames[14], drinksimages[14], smoothy));
        icdats.add(new Icdat(drinksnames[15], drinksimages[15], smoothy));
        icdats.add(new Icdat(drinksnames[16], drinksimages[16], smoothy));
        icdats.add(new Icdat(drinksnames[17], drinksimages[17], smoothy));
        icdats.add(new Icdat(drinksnames[18], drinksimages[18], smoothy));
        icdats.add(new Icdat(drinksnames[19], drinksimages[19], smoothy));
        icdats.add(new Icdat(drinksnames[20], drinksimages[20], smoothy));
        icdats.add(new Icdat(drinksnames[21], drinksimages[21], smoothy));
        icdats.add(new Icdat(drinksnames[22], drinksimages[22], smoothy));
        icdats.add(new Icdat(drinksnames[23], drinksimages[23], smoothy));
        icdats.add(new Icdat(drinksnames[24], drinksimages[24], smoothy));
        icdats.add(new Icdat(drinksnames[25], drinksimages[25], smoothy));
        icdats.add(new Icdat(drinksnames[26], drinksimages[26], smoothy));
        icdats.add(new Icdat(drinksnames[27], drinksimages[27], smoothy));
        icdats.add(new Icdat(drinksnames[28], drinksimages[28], smoothy));
        icdats.add(new Icdat(drinksnames[29], drinksimages[29], smoothy));
        icdats.add(new Icdat(drinksnames[30], drinksimages[30], smoothy));
        icdats.add(new Icdat(drinksnames[31], drinksimages[31], smoothy));
        icdats.add(new Icdat(drinksnames[32], drinksimages[32], smoothy));
        icdats.add(new Icdat(drinksnames[33], drinksimages[33], smoothy));
        icdats.add(new Icdat(drinksnames[34], drinksimages[34], smoothy));
        icdats.add(new Icdat(drinksnames[35], drinksimages[35], smoothy));
        icdats.add(new Icdat(drinksnames[36], drinksimages[36], smoothy));
        icdats.add(new Icdat(drinksnames[37], drinksimages[37], smoothy));
        icdats.add(new Icdat(drinksnames[38], drinksimages[38], smoothy));
        icdats.add(new Icdat(drinksnames[39], drinksimages[39], smoothy));
        icdats.add(new Icdat(drinksnames[40], drinksimages[40], smoothy));
        icdats.add(new Icdat(drinksnames[41], drinksimages[41], smoothy));
        return icdats;
    }
